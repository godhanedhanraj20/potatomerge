...
bool_vars = ['AS_DOCUMENT', 'ENABLE_WATERMARK', 'BOT_PM', 'STOP_DUPLICATE', 'SET_COMMANDS', 'SAVE_MSG', 'SHOW_MEDIAINFO', 'SOURCE_LINK', 'SAFE_MODE', 'SHOW_EXTRA_CMDS',
             'IS_TEAM_DRIVE', 'USE_SERVICE_ACCOUNTS', 'WEB_PINCODE', 'EQUAL_SPLITS', 'DISABLE_DRIVE_LINK', 'DELETE_LINKS', 'CLEAN_LOG_MSG', 'USER_TD_MODE', 
             'INCOMPLETE_TASK_NOTIFIER', 'UPGRADE_PACKAGES', 'SCREENSHOTS_MODE', 'AUTO_THUMBNAIL', 'MERGE_VIDEO']

unauth_config = ['TELEGRAM_HASH', 'TELEGRAM_API', 'OWNER_ID', 'DATABASE_URL', 'UPSTREAM_REPO', 'UPSTREAM_BRANCH', 'BOT_TOKEN', 'MEGA_EMAIL', 'MEGA_PASSWORD', 'USER_SESSION_STRING']
...
async def load_config():
    ...
    MERGE_VIDEO = environ.get('MERGE_VIDEO', '')
    MERGE_VIDEO = MERGE_VIDEO.lower() == 'true'

    ENABLE_WATERMARK = environ.get('ENABLE_WATERMARK', '')  
    ENABLE_WATERMARK = ENABLE_WATERMARK.lower() == 'true'

    LIB264_PRESET = environ.get('LIB264_PRESET', 'ultrafast')
