...
default_desp = {'AS_DOCUMENT': 'Default type of Telegram file upload. Default is False mean as media.',
                ...
                'AUTO_THUMBNAIL': 'The thumbnail will be grabbed directly from TMDb(The Movie Database). Bool',
                'MERGE_VIDEO': 'This will allow merging of different videos(Not a single file with different parts like .001, .002) in a single video. Bool',
                'METADATA': 'Your channel name that will be used while editing metadata of the video file. Send Metadata Text. Str',
                'ATTACHMENT_URL': 'Your channel thumbnail that will be used while adding attachment of the video file. Send Attachment Image Url. Str',
                'ENABLE_WATERMARK': 'Enable add watermark to the video file. Default is False. Bool',
                'LIB264_PRESET': '''
                ultrafast - Fastest encoding speed, lowest compression efficiency (largest file sizes).
                superfast - Very fast encoding speed, still low compression efficiency.
                veryfast - Fast encoding speed, low compression efficiency.
                faster - Slightly slower than veryfast, better compression.
                fast - Balanced speed and compression.
                medium (default) - Default preset, balanced between speed and compression efficiency.
                slow - Slower encoding, better compression efficiency.
                slower - Even slower encoding, better compression.
                veryslow - Very slow encoding, best compression efficiency.
                placebo - Slowest encoding, but the best compression (usually not practical due to long encoding times).
                ''',
                'FFMPEG_CRF': '''
                0: Lossless (perfect quality, largest file size).
                18-22: High-quality range, often indistinguishable from the original. 18 is visually lossless for most users.
                23: Default value, provides good balance between file size and quality.
                24-28: Medium quality, often acceptable for streaming or lower storage needs.
                29-35: Lower quality, suitable for very small file sizes or applications where quality loss is acceptable.
                36-51: Very low quality, small file sizes with significant loss of detail.
                ''',
