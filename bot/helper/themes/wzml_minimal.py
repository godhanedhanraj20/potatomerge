...
┠<b> Mirror AutoRename :</b> <code>{MAUTORENAME}</code>
...
┠<b> Leech AutoRename :</b> <code>{LAUTORENAME}</code>
┠<b> Leech Prefix :</b> <code>{LPREFIX}</code>
┠<b> Leech Suffix :</b> <code>{LSUFFIX}</code>
┠<b> Leech Dumps :</b> <code>{LDUMP}</code>
┖<b> Leech Remname :</b> <code>{LREMNAME}</code>'''

    VIDTOOL = '''㊂ <b><u>Video Tools for {NAME}</u></b>
...
┠<b> Auto Thumbnail :</b> <code>{AUTO_THUMB}</code>
┠<b> Trim :</b> <code>{FTRIM}</code>
┠<b> Intro Subtrack :</b> <code>{FEXSUBTRACK}</code>
┠<b> Audio Remove :</b> <code>{AUDIOREMOVE}</code>
┖<b> Audio Swap :</b> <code>{FAUDIOCHANGE}</code>'''
